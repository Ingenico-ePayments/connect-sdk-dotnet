...
namespace Ingenico.Connect.Sdk
{
    ...
    {
        CommunicatorConfigurationSection _section { get; set; } = new CommunicatorConfigurationSection();
        /// <summary>
        ...
        internal UriConfiguration ApiEndpointConfig
        {
            get
            {
                return _section.ApiEndpointConfig;
            }
        }
        ...
        public Uri ApiEndpoint
        {
            get
            {
                return _section.ApiEndpoint;
            }
            set
            {
                _section.ApiEndpoint = value;
            }
        }
        ...
        public TimeSpan? ConnectTimeout
        {
            get
            {
                return _section.ConnectTimeout;
            }
            set
            {
                _section.ConnectTimeout = value;
            }
        }
        ...
        public TimeSpan? SocketTimeout
        {
            get
            {
                return _section.SocketTimeout;
            }
            set
            {
                _section.SocketTimeout = value;
            }
        }
        ...
        public int MaxConnections
        {
            get
            {
                return _section.MaxConnections;
            }
            set
            {
                _section.MaxConnections = value;
            }
        }
        ...
        public AuthorizationType AuthorizationType
        {
            get
            {
                return AuthorizationType.GetValueOf(_section.AuthorizationType);
            }
            set
            {
                _section.AuthorizationType = value.SignatureString;
            }
        }
        ...
        public string ApiKeyId
        {
            get
            {
                return _section.ApiKeyId;
            }
            set
            {
                _section.ApiKeyId = value;
            }
        }
        ...
        public string SecretApiKey
        {
            get
            {
                return _section.SecretApiKey;
            }
            set
            {
                _section.SecretApiKey = value;
            }
        }
        ...
        internal ProxyConfiguration ProxyConfiguration
        {
            get
            {
                return _section.ProxyConfiguration;
            }
        }
        ...
        public Uri ProxyUri
        {
            get
            {
                return _section.ProxyUri;
            }
            set
            {
                _section.ProxyUri = value;
            }
        }
        ...
        public string ProxyUserName
        {
            get
            {
                return _section.ProxyUserName;
            }
            set
            {
                _section.ProxyUserName = value;
            }
        }
        ...
        public string ProxyPassword
        {
            get
            {
                return _section.ProxyPassword;
            }
            set
            {
                _section.ProxyPassword = value;
            }
        }
        ...
        public string Integrator
        {
            get
            {
                return _section.Integrator;
            }

            set
            {
                _section.Integrator = value;
            }
        }
        ...
        public ShoppingCartExtension ShoppingCartExtension
        {
            get
            {
                return _section.ShoppingCartExtension;
            }

            set
            {
                _section.ShoppingCartExtension = value;
            }
        }
        ...
        static int GetProperty(IDictionary<string, string> properties, string key, int defaultValue)
        {
            ...
            int propertyInt;
            if (int.TryParse(propertyValue, out propertyInt))
            {
                return propertyInt;
            }
            return defaultValue;
