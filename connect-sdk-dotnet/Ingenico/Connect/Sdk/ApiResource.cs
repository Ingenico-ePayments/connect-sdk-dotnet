...
namespace Ingenico.Connect.Sdk
{
    ...
    public class ApiResource
    {
        ...
        protected ApiResource(Communicator communicator, string clientMetaInfo, IDictionary<string, string> pathContext)
        {
            ...
            {
                throw new ArgumentException("communicator is required");
            }
            _parent = null;
        ...
        string ReplaceAll(string uri, IDictionary<string, string> pathContext)
        {
            if (pathContext != null)
            {
        ...
        bool IsIdempotenceError(IEnumerable<APIError> errors, CallContext context)
        {
            return context != null
