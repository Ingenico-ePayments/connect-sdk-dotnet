...
namespace Ingenico.Connect.Sdk.DefaultImpl
{
  ...
  status-code:  '200'
  headers:      'Dummy=""""") + @"(,\ Server=""[^""]*"")?" + Regex.Escape(@", Date=""") + @"[^""]+" + Regex.Escape(@"""") + @"[^']*" + Regex.Escape(@"'
  content-type: 'application/json'
  body:         '{
   ""convertedAmount"" : 4547504
}'");

        string createPaymentFailureRejectedJson = @"{
    ...
    ""paymentResult"": {
        ...
        string createPaymentFailureRejectedRequest = Regex.Escape(@"Outgoing request (requestId='") + @"([-a-zA-Z0-9]+)" + Regex.Escape(@"'):
  method:       'POST'
  ...
  body:         '{""cardPaymentMethodSpecificInput"":{""card"":{""cvv"":""***"",""cardNumber"":""************3452"",""expiryDate"":""**20""},""paymentProductId"":1},""order"":{""amountOfMoney"":{""amount"":2345,""currencyCode"":""CAD""},""customer"":{""billingAddress"":{""countryCode"":""CA""}}}}'");
        ...
        string createPaymentFailureRejectedResponse = Regex.Escape(@"Incoming response (requestId='") + @"([-a-zA-Z0-9]+)" + Regex.Escape(@"' + '") + @"[0-9]*" + Regex.Escape(@"' ms):
  status-code:  '402'
  headers:      'Dummy=""""") + @"(,\ Server=""[^""]*"")?" + Regex.Escape(@", Date=""") + @"[^""]+" + Regex.Escape(@"""") + @"[^']*" + Regex.Escape(@"'
  content-type: 'application/json'
  body:         '{
    ...
    ""payment"": {
        ...
        string createPaymentRequest = Regex.Escape(@"Outgoing request (requestId='") + @"([-a-zA-Z0-9]+)" + Regex.Escape(@"'):
  method:       'POST'
  uri:          '/v1/1234/payments'
  ...
  body:         '{""cardPaymentMethodSpecificInput"":{""card"":{""cvv"":""***"",""cardNumber"":""************3456"",""expiryDate"":""**20""},""paymentProductId"":1},""order"":{""amountOfMoney"":{""amount"":2345,""currencyCode"":""CAD""},""customer"":{""billingAddress"":{""countryCode"":""CA""}}}}'");
        ...
        string createPaymentResponse = Regex.Escape(@"Incoming response (requestId='") + @"([-a-zA-Z0-9]+)" + Regex.Escape(@"' + '") + @"[0-9]*" + Regex.Escape(@"' ms):
  status-code:  '201'
  ...
  body:         '{
    ...
    ""errors"": [
        ...
        string createPaymentFailureInvalidCardNumberJsonRequest = Regex.Escape(@"Outgoing request (requestId='") + @"([-a-zA-Z0-9]+)" + Regex.Escape(@"'):
  method:       'POST'
  uri:          '/v1/1234/payments'
  headers:      'X-GCS-ServerMetaInfo=""") + @"[^""]*" + Regex.Escape(@""", Date=""") + @"[^""]+" + Regex.Escape(@""", Authorization=""********""") + @"[^']*" + Regex.Escape(@"'
  content-type: 'application/json'
  body:         '{""cardPaymentMethodSpecificInput"":{""card"":{""cvv"":""***"",""cardNumber"":""************3456"",""expiryDate"":""**20""},""paymentProductId"":1},""order"":{""amountOfMoney"":{""amount"":2345,""currencyCode"":""CAD""},""customer"":{""billingAddress"":{""countryCode"":""CA""}}}}'");
        ...
        string createPaymentFailureInvalidCardNumberJsonResponse = Regex.Escape(@"Incoming response (requestId='") + @"([-a-zA-Z0-9]+)" + Regex.Escape(@"' + '") + @"[0-9]*" + Regex.Escape(@"' ms):
  status-code:  '400'
  headers:      'Dummy=""""") + @"(,\ Server=""[^""]*"")?" + Regex.Escape(@", Date=""") + @"[^""]+" + Regex.Escape(@"""") + @"[^']*" + Regex.Escape(@"'
  content-type: 'application/json'
  body:         '{
    ...
    ""errors"": [
        ...
        string deleteTokenRequest = Regex.Escape(@"Outgoing request (requestId='") + @"([-a-zA-Z0-9]+)" + Regex.Escape(@"'):
  method:       'DELETE'
  uri:          '/v1/1234/tokens/5678'
  headers:      'X-GCS-ServerMetaInfo=""") + @"[^""]*" + Regex.Escape(@""", Date=""") + @"[^""]+" + Regex.Escape(@""", Authorization=""********""") + @"[^']*" + Regex.Escape(@"'");
        string deleteTokenResponse = Regex.Escape(@"Incoming response (requestId='") + @"([-a-zA-Z0-9]+)" + Regex.Escape(@"' + '") + @"[0-9]*" + Regex.Escape(@"' ms):
  status-code:  '204'
  headers:      'Dummy=""""") + @"(,\ Server=""[^""]*"")?" + Regex.Escape(@", Date=""") + @"[^""]+" + Regex.Escape(@"""") + @"[^']*" + Regex.Escape(@"'
  content-type: ''
  body:         ''");
        
        string testConnectionJson = @"{
    ""result"": ""OK""
}";
        
        string testConnectionRequest = Regex.Escape(@"Outgoing request (requestId='") + @"([-a-zA-Z0-9]+)" + Regex.Escape(@"')") + Regex.Escape(@":
  method:       'GET'
  uri:          '/v1/1234/services/testconnection'
  headers:      'X-GCS-ServerMetaInfo=""") + @"[^""]*" + Regex.Escape(@""", Date=""") + @"[^""]+" + Regex.Escape(@""", Authorization=""********""") + @"[^']*" + Regex.Escape(@"'");
        
        string testConnectionResponse = Regex.Escape(@"Incoming response (requestId='") + @"([-a-zA-Z0-9]+)" + Regex.Escape(@"' + '") + @"[0-9]*" + Regex.Escape(@"' ms):
  status-code:  '200'
  headers:      'Dummy=""""") + @"(,\ Server=""[^""]*"")?" + Regex.Escape(@", Date=""") + @"[^']*" + Regex.Escape(@"'
  content-type: 'application/json'
  body:         '{
    ""result"": ""OK""
}'");

        string binaryRequestRequest = Regex.Escape(@"Outgoing request (requestId='") + @"([-a-zA-Z0-9]+)" + Regex.Escape(@"'):
  method:       'POST'
  uri:          '/binaryRequest'
  headers:      'X-GCS-ServerMetaInfo=""") + @"[^""]*" + Regex.Escape(@""", Date=""") + @"[^""]+" + Regex.Escape(@""", Authorization=""********""") + @"[^']*" + Regex.Escape(@"'
  ...
  body:         '<binary content>'");
        ...
        string binaryRequestResponse = Regex.Escape(@"Incoming response (requestId='") + @"([-a-zA-Z0-9]+)" + Regex.Escape(@"' + '") + @"[0-9]*" + Regex.Escape(@"' ms):
  status-code:  '204'
  headers:      '") + @"[^']*" + Regex.Escape(@"Dummy=""""") + @"[^']*" + Regex.Escape(@", Date=""") + @"[^""]+" + Regex.Escape(@"""") + @"[^']*" + Regex.Escape(@"'
  content-type: ''
  body:         ''");

        string binaryResponseRequest = Regex.Escape(@"Outgoing request (requestId='") + @"([-a-zA-Z0-9]+)" + Regex.Escape(@"'):
  method:       'GET'
  uri:          '/binaryContent'
  headers:      '") + @"[^']*" + Regex.Escape(@"'");

        string binaryResponseResponse = Regex.Escape(@"Incoming response (requestId='") + @"([-a-zA-Z0-9]+)" + Regex.Escape(@"' + '") + @"[0-9]*" + Regex.Escape(@"' ms):
  status-code:  '200'
  headers:      '") + @"[^']*" + Regex.Escape(@"Dummy=""""") + @"[^']*" + Regex.Escape(@", Date=""") + @"[^']*" + Regex.Escape(@"'
  content-type: 'application/octet-stream'
  body:         '<binary content>'");

        string unknownServerErrorJson = @"{
    ...
    ""errors"": [
        ...
        string unknownServerErrorResponse = @"" + Regex.Escape(@"Incoming response (requestId='") + @"([-a-zA-Z0-9]+)" + Regex.Escape(@"' + '") + @"[0-9]*" + Regex.Escape(@"' ms):
  status-code:  '500'
  headers:      'Dummy=""""") + @"(,\ Server=""[^""]*"")?" + Regex.Escape(@", Date=""") + @"[^']*" + Regex.Escape(@"'
  content-type: 'application/json'
  body:         '{
    ...
    ""errors"": [
        ...
        string notFoundHtml = @"Not Found";
        string notFoundResponse = Regex.Escape(@"Incoming response (requestId='") + @"([-a-zA-Z0-9]+)" + Regex.Escape(@"' + '") + @"[0-9]*" + Regex.Escape(@"' ms):
  status-code:  '404'
  headers:      'Dummy=""""") + @"(,\ Server=""[^""]*"")?" + Regex.Escape(@", Date=""") + @"[^']*" + Regex.Escape(@"'
  content-type: 'text/html'
  body:         'Not Found'");
        string genericError = Regex.Escape(@"Error occurred for outgoing request (requestId='") + @"([-a-zA-Z0-9]+)" + Regex.Escape(@"')");
