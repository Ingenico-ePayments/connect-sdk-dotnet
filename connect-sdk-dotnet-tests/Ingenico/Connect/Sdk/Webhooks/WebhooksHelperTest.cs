  ...
  ""payment"": {
    ...
    ""statusOutput"": {
      ...
      ""isAuthorized"": true
        ...
        string KeyId = "dummy-key-id";
        string SecretKey = "hello+world";

        string KeyIdHeader = "X-GCS-KeyId";
        string SignatureGood = "2S7doBj/GnJnacIjSJzr5fxGM5xmfQyFAwxv1I53ZEk=";
        string SignatureWrongApi = "O5FDUZyrDO+9fuQ1hD187HRbJLkUlBEht2eAL9jV/kU=";
        string SignatureHeader = "X-GCS-Signature";
